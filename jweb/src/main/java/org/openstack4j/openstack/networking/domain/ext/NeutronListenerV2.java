...
public class NeutronListenerV2 implements ListenerV2 {
    ...
    private List<Map<String,String>> loadbalancers;
     ...
     */
    @Override
    public List<Map<String,String>> getLoadBalancers(){
    ...
    public String getLoadBalancerId() {
    	...
    	if(loadbalancers!=null && loadbalancers.size()>0) {
    		loadBalancerId = loadbalancers.get(0).get("id");
    	}
    ...
    public static class ListenerConcreteBuilder implements ListenerV2Builder {
         ...
         */
        @Override
        public ListenerV2Builder loadbalancers(List<Map<String,String>> loadbalancers){

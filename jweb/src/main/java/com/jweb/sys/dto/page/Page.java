...
public class Page {
	...
	public String getHeadHTML() {
		...
		//required css
		csses.add(0,"plugins/bootstrap/css/bootstrap.min.css");
		csses.add("plugins/page/css/base.css");
		//required js
		jses.add(0,"plugins/jquery-2.1.4/jquery.min.js");
		jses.add(1,"plugins/proper/popper.min.js");
		jses.add(2,"plugins/bootstrap/js/bootstrap.min.js");
		jses.add(3,"plugins/page/js/base.js");

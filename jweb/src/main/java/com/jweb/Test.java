...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(os.compute().hypervisors().statistics());
       /* String token = os.getToken().getId();
        ...
        /*for (int x = 0; x < 10; x++) {
            ...
            System.out.println("总投硬币数量:" + total);
            System.out.println("正面朝上:" + s);
            System.out.println("连续相同" + p + "次:" + ptotal);
            System.out.println("出现连续相同时进行反压成功:" + ps);
